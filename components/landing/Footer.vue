    ...
    <div class="max-w-5xl mx-auto px-4 py-12">
      ...
      <div class="grid grid-cols-1 gap-8 mb-8">
        ...
        <div class="hidden">
          ...
          <ul class="space-y-2">
            <li>
              <NuxtLink to="/services" class="hover:text-white transition-colors">
                Services
              </NuxtLink>
            </li>
            <li>
            ...
            <li>
              <NuxtLink to="/blog" class="hover:text-white transition-colors">
                Blog
              </NuxtLink>
            </li>
          </ul>
        ...
        <div class="hidden">
          ...
          <ul class="space-y-2">
            <li>
              <NuxtLink to="/services/social-media" class="hover:text-white transition-colors">
                Social Media Management
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/services/digital-marketing" class="hover:text-white transition-colors">
                Digital Marketing
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/services/content-creation" class="hover:text-white transition-colors">
                Content Creation
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/services/automation" class="hover:text-white transition-colors">
                Business Automation
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/services/consulting" class="hover:text-white transition-colors">
                Business Consulting
              </NuxtLink>
            </li>
          </ul>
        ...
        <div class="flex flex-col items-center">
          ...
          <ul class="gap-4 flex-wrap flex items-center justify-center">
            ...
            <li class="flex items-start">
              ...
              <span>info@eazzysocial.com</span>
            </li>
            <li class="hidden items-start">
              <svg class="h-6 w-6 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
              </svg>
              <span>+233 558 221 551</span>
            </li>
          </ul>
        </div>
      </div>
